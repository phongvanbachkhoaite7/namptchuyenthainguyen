...
import { deleteData, updateData } from "../../redux/ActionCreators";
import { useDispatch } from "react-redux";
import dateFormat from "dateformat";

function EditStaffForm(props) {
  const dispatch = useDispatch();
  let [newStaff, setNewStaff] = useState(props.staffEdit);
  ...
  if (props.hienThiForm === true) {
    return (
      <div className="col bg-warning card-view-without-link">
        <div>
          <h5 className="tieuDeTrang text-center mt-2">
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-12">
                <input
                  ...
                  id="name"
                  name="name"
                  defaultValue={props.staffEdit.name}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  id="doB"
                  name="doB"
                  defaultValue={dateFormat(props.staffEdit.doB, "yyyy-mm-dd")}
                  onBlur={(event) => isChange(event)}
                />
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-12">
                <select
                  ...
                  name="department"
                  defaultValue={props.staffEdit.department}
                  onBlur={(event) => isChange(event)}
                >
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-12">
                <input
                  ...
                  defaultValue={props.staffEdit.salaryScale}
                  onBlur={(event) => isChange(event)}
                />
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-12">
                <input
                  ...
                  defaultValue={props.staffEdit.annualLeave}
                  onBlur={(event) => isChange(event)}
                />
              </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-12">
                <input
                  ...
                  defaultValue={props.staffEdit.overTime}
                  onBlur={(event) => isChange(event)}
                />
              </div>
